...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="bg-cream px-6 pb-[120px] pt-[70px] text-forest-dark">
        <div className="mx-auto max-w-4xl rounded-3xl border border-gold/25 bg-white/65 p-9 text-center shadow-[0_12px_40px_rgba(15,46,42,0.08)] backdrop-blur-sm md:p-12">
          <p className="font-body text-xs font-medium uppercase tracking-[0.22em] text-gold">Careers</p>
          <h2 className="mt-4 font-display text-3xl font-bold leading-tight md:text-[40px]">Join Us</h2>
