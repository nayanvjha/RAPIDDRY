    ...
    <section id="reviews" className="relative overflow-hidden bg-forest-dark px-6 py-[80px] text-cream">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-bold leading-tight text-cream md:text-5xl">Reviews Coming Soon</h2>
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-gold/20 bg-[rgba(24,63,58,0.7)] p-8 text-center backdrop-blur-[12px]">
