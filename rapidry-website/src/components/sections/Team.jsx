...
export default function Team() {
  ...
  return (
    <section id="team" ref={sectionRef} className="bg-forest-dark px-6 py-[100px] text-cream">
      <div className="mx-auto max-w-6xl">
          ...
          {TEAM_MEMBERS.map((member, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative mx-auto inline-flex h-[140px] w-[140px] items-center justify-center rounded-full border-[2.5px] border-gold text-gold">
                  ...
                  {isOpenRole ? (
                    <Plus size={42} className="animate-[spin_8s_linear_infinite] transition group-hover:animate-[spin_2.5s_linear_infinite]" />
                  ) : (
                    <span className="relative font-display text-[40px] font-bold">
        ...
        <div className="relative mx-auto mt-12 max-w-[680px] rounded-2xl border border-gold/20 bg-[rgba(24,63,58,0.8)] p-8 text-center">
          <span className="pointer-events-none absolute left-5 top-1 font-display text-7xl text-gold/20">“</span>
          <p className="font-display text-[19px] italic leading-relaxed text-cream/90">
